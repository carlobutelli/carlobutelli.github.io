...
Gem::Specification.new do |spec|
  spec.name          = "carlo-personal-website"
  spec.version       = "1.0.0"
  spec.authors       = ["Carlo Butelli"]
  spec.email         = ["dev.butelli@gmail.com"]

  spec.summary       = %q{Carlo Butelli personal website}
  ...
  spec.homepage      = "https://carlobutelli.github.io"
  spec.license       = "MIT"
